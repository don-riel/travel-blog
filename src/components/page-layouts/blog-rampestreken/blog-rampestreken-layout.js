...
export default function Blog_Rampestreken() {
    ...
    return (
        <div className={general_blog_styles.blog_content_container}>
            ...
            <Fade bottom>
                <p>Gigantic mountains, crystal clear rivers, streams and waterfalls, colourful cabins and houses entertained us along the way. 
                    It was so surreal seeing the gigantic Trollwall. We drove straight to Gjerdsetbygda Turistsenter where we stayed for our first day. 
                    The town was so picturesque- mountains surrounding lakes and the sea. Åndalsnes is known as the mountaineering capital of Norway, and it was too obvious seeing people who were actually in hiking attires. 
                    The mountain and lake views were splendid, I could live there. The apartment itself was cozy, spacious and relaxing, plus the host was so helpful. 
                    He lived in a bobil or RV just in front of the house.
                </p>
            </Fade>

            <Fade bottom>
                <p>We took our lunch in the senter with our packed lunch, rested for a while and drove 10 minutes to the starting point of our hike, Rampestreken. 
                    Rampestreken is not as popular as Trolltunga or Preikestolen, but is just as wonderful as the two. 
                    It is considered a moderate hike, an average of 2-3hr back and forth. 
                    Even children and people of age can hike it. In fact we met kids and oldies along the hike.
                </p>
            </Fade>

            <Fade bottom>
                <p>After the hike, we drove back to the Gjerdsetbygda and took advantage of the free kayaking offered in the hostel. 
                    Imagine after a 6hr drive, we managed to hike and do kayaking?
                </p>
            </Fade>
