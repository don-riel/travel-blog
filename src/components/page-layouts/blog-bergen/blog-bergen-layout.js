...
export default function Blog_Bergen() {
    ...
    return (
        <div className={general_blog_styles.blog_content_container}>
            ...
            <Fade bottom>
                <p>We both had the weekend free so I booked the trip right after we agreed. It was a week before the travel. 
                    I thought this would be in a way or another help us to relax a bit, forget about work and deadlines for a while. 
                    Luckily NSB was on sale, and I used the OBOS member card to avail discount for our hotel.
                </p>
            </Fade>
            ...
            <Fade bottom>
                <p>It snowed hard 2 days before the trip, and was on the evening news that a storm is coming to Bergen.
                     Bergen is actually the rainiest city in Norway, with an average of 240 days a year- so is that even a news?
                </p>
            </Fade>

            <Fade bottom>
                <p>We took the morning trip on a Saturday, around 8AM and should be arriving in Bergen around 3PM hoping to get the best views along the way. 
                    Sadly, it was so foggy and most of the pictures and clips we took were out of luck. 
                    Mr. sun was too shy to show throughout the journey, but the train ride and the view was still phenomenal- the clouds were actually dramatic in a way.
                </p>
            </Fade>

            <Fade bottom>
                <p>We reached Bergen an hour late because of traffic. It was drizzling and windy and chilly, and since it is winter season, 4:00 was already dark. 
                    Nevertheless, we strolled around the city after we checked in at the hotel. 
                    One of the many things I forgot to consider when I booked was that it was Sunday the next day. 
                    In Norway, most of the shops are closed during Sundays. 
                    It is the law and Sundays are considered as family day, a day to go to the mountains or to the woods or anywhere where nature is. 
                    But the best thing during Sundays is that it is not crowded and most of the tourist attractions are still open. We only had a day to stroll the city. 
                    Thank heavens it did not rain that day, though Mr. Sun was still missing.</p>
            </Fade>
