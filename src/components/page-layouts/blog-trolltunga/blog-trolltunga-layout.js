    ...
    <div className={general_blog_styles.blog_content_container}>
      ...
      <Fade bottom>
        <p>
          ...
          hours back and forth. And according to those who have done the hike,
      ...
      <Fade bottom>
        <p>
          ...
          It was not easy to find the red T sign. There were lots of hikers so
          we just had to follow footprints. It took us 3 hours to reach the
          tongue and four and a half hours to go back to the parking. Yes 4.5
      ...
      <Fade bottom>
        <div className={general_blog_styles.iframe_box}>
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/8476SIFmMsw"
